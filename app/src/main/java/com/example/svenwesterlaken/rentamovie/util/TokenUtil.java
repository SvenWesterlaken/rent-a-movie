...
public class TokenUtil {
    ...
    public static boolean tokenAvailable(Context context) {
        ...
        String token = sharedPreferences.getString(context.getString(R.string.saved_token), "default token");
    ...
    public static boolean tokenValid(Context context) {
        ...
        SharedPreferences sharedPreferences = context.getSharedPreferences(context.getString(R.string.preference_file_key), Context.MODE_PRIVATE);
        long timestamp = sharedPreferences.getLong(context.getString(R.string.token_expiration_timestamp), 1497517801L);

        if (Long.valueOf(timestamp) != null && timestamp != 1497517801L) {
